        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-text leading-[1.1]">
              Building tested backend and full-stack products for real users.
            </h1>
          </div>

          <p className="text-base md:text-lg text-text-secondary leading-relaxed max-w-xl">
            I build TypeScript, React, Next.js, Python, Django, and PostgreSQL systems with practical product thinking, API discipline, tests, CI/CD, and deployment-ready documentation.
          </p>
          ...
          <div className="relative w-full max-w-md aspect-square">
            <div className="absolute inset-0 rounded-lg border border-border bg-surface/50 p-6 font-mono text-sm text-text-secondary shadow-sm">
              ...
              <div className="space-y-2">
                ...
                <p className="pl-4">focus: <span className="text-success">&quot;backend + full-stack&quot;</span>,</p>
                <p className="pl-4">stack: [<span className="text-success">&quot;TypeScript&quot;</span>, <span className="text-success">&quot;Python&quot;</span>, <span className="text-success">&quot;PostgreSQL&quot;</span>],</p>
                <p className="pl-4">status: <span className="text-success">&quot;shipping&quot;</span></p>
                <p>{'}'};</p>
              </div>
            </div>
          </div>
