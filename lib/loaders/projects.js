...
import candyBeautyData from '@/content/projects/candy-beauty.json'
import talentosData from '@/content/projects/talentos.json'
...
export function loadFeaturedProjects(limit = 4) {
